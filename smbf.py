...
def ugen():
	rr = random.randint
	rc = random.choice
	return rc([f"Mozilla/5.0 (Linux; Android 7.0; Lenovo K33a42) AppleWebKit/537.36 (KHTML, like Gecko) SalamWeb/4.4.0.36 Chrome/{str(rr(30,114))}.0.{str(rr(3000,4555))}.{str(rr(80,150))} Mobile Safari/537.36"])
