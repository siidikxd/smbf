...
def ugen():
	rr = random.randint
	rc = random.choice
	aa = f"Mozilla/5.0 (Linux; Android 4.4.2; SM-N900S Build/KOT49H) AppleWebKit/537.36 (KHTML like Gecko) Version/4.0 Chrome/{str(rr(10,113))}.0.{str(rr(1111,5999))}.{str(rr(45,150))} Mobile Safari/537.36 NAVER(inapp; search; 320; 5.8.5)"
	bb = f"Mozilla/5.0 (Linux; Android 8.1.0; BBB100-5 Build/OPM1.171019.026) AppleWebKit/537.36 (KHTML, like Gecko) SFive_Android/{str(rr(10,113))}.0.{str(rr(1111,5999))}.{str(rr(45,150))} Chrome/{str(rr(10,113))}.0.{str(rr(1111,5999))}.{str(rr(45,150))} Mobile Safari/537.36"
...
def generateuseragentdalvik():
	...
	model = random.choice(["21121210G Build/TKQ1.220807.001"])
	...
	return (f"Dalvik/2.1.0 (Linux; U; Android {versi}) {model}) [FBAN/MobileAdsManagerAndroid;FBAV/{versi_apk};FBBV/{versi_app};FBRV/0;FBPN/com.facebook.adsmanager;FBLC/id_ID;FBMF/Xiaomi;FBBD/POCO;FBDV/21121210G;FBSV/{versi};FBCA/arm64-v8a:armeabi-v7a:armeabi;FBDM/"+"{density=2.75,width=1080,height=2186};FB_FW/1;]")
